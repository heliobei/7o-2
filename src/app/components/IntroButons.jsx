...
function IntroButons() {
  const sites = [
    { name: 'Site 1', url: 'https://7oano.beieducacaopedagogico.com/' },
    { name: 'Site 3', url: 'https://7oano-3.beieducacaopedagogico.com/' },
    { name: 'Site 4', url: 'https://7oano-4.beieducacaopedagogico.com/' }
  ];
